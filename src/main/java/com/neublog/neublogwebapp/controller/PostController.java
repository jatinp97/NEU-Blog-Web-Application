...
import com.neublog.neublogwebapp.util.ROLE;
...
//    }
    ...
    public String posts(Model model){
        ...
        //Return Model and View ------ under admin folder creating a posts thymleaf view
    }
    ...
    public String createPost(@Valid @ModelAttribute("post") PostDto postDto,
                             ...
                             Model model){ //ModelAttribute will read form data and set the valuse
        if(result.hasErrors()){
            model.addAttribute("post", postDto);
            return "/admin/create_post";
        }
        ...
        return "redirect:/admin/posts"; //redirect list blog page.
    }
...
//admin/posts/search?query="UserEnteredKeyWord"
@GetMapping("/admin/posts/search")
    ...
    //handler to handle the List of Comment Request
